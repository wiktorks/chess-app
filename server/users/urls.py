...
from users.rest_views import RegisterUserView, UserViewSet, ActivateAccountView, ResetPasswordView
...
urlpatterns = [
    ...
    path('profiles/password-reset/', ResetPasswordView.as_view(), name='user-password-reset'),
